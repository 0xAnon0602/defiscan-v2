...
- comparing to: main@b550f9ac139cd5a8b94cff800a83bc8fee01fa50 block: 1779488609
- current timestamp: 1779707133
...
```diff
    ...
    +++ description: None
      values.price:
-        "759834933535300000000000000000000000000"
...
```diff
    ...
    +++ description: None
      values.price:
-        "762875443415238844362000000000000000000"
...
```diff
    ...
    +++ description: None
      values.price:
-        "758011829831246568552622365380575589944"
